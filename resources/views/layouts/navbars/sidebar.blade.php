<div class="sidebar" data-color="red" data-background-color="white" data-image="{{ asset('material') }}/img/LogoFGE.jpg"> 
  <!--
  ...
  <div class="sidebar-wrapper">
    <ul class="nav">
      ...
      <li class="nav-item {{ ($activePage == 'cedula' || $activePage == 'pre-ambar' || $activePage == 'ambar' || $activePage == 'alba' ) ? ' active' : '' }}">
        ...
        <div class="collapse show" id="Fichas">
          <ul class="nav">
            <li class="nav-item{{ $activePage == 'cedula' ? ' active' : '' }}">
            ...
            <li class="nav-item{{ $activePage == 'pre-ambar' ? ' active' : '' }}">
              <a class="nav-link" href="{{ route('user.index') }}">
                <span class="sidebar-mini"> UM </span>
                <span class="sidebar-normal"> {{ __('Alertas pre-ambar') }} </span>
              </a>
            </li>
            <li class="nav-item{{ $activePage == 'ambar' ? ' active' : '' }}">
              <a class="nav-link" href="{{ route('user.index') }}">
                <span class="sidebar-mini"> UM </span>
                <span class="sidebar-normal"> {{ __('Alertas ambar') }} </span>
              </a>
            </li>
